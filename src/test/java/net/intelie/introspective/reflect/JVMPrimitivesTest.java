...
public class JVMPrimitivesTest {
    ...
    public void testExtended() {
        assertThat(JVMPrimitives.getFastPath(Byte.class, 42)).isEqualTo(12 + 1);
        assertThat(JVMPrimitives.getFastPath(Short.class, 42)).isEqualTo(12 + 2);
        assertThat(JVMPrimitives.getFastPath(Integer.class, 42)).isEqualTo(12 + 4);
        assertThat(JVMPrimitives.getFastPath(Long.class, 42)).isEqualTo(12 + 8);
        assertThat(JVMPrimitives.getFastPath(Float.class, 42)).isEqualTo(12 + 4);
        assertThat(JVMPrimitives.getFastPath(Double.class, 42)).isEqualTo(12 + 8);
        assertThat(JVMPrimitives.getFastPath(Boolean.class, 42)).isEqualTo(12 + 1);
        assertThat(JVMPrimitives.getFastPath(Character.class, 42)).isEqualTo(12 + 2);
    }
}